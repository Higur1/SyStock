/*
  ...
  - You are about to drop the column `dateTime` on the `fill` table. All the data in the column will be lost.
...
INSERT INTO "new_batch" ("createdAt", "dateTimeEmptyStock", "deletionStatus", "eValidationStatus", "expirationDate", "id", "product_id", "quantity", "updatedAt") SELECT "createdAt", "dateTimeEmptyStock", "deletionStatus", "eValidationStatus", "expirationDate", "id", "product_id", "quantity", "updatedAt" FROM "batch";
DROP TABLE "batch";
...
INSERT INTO "new_fill" ("createdAt", "id", "observation", "supplier_id", "totalPrice", "updatedAt", "user_id") SELECT "createdAt", "id", "observation", "supplier_id", "totalPrice", "updatedAt", "user_id" FROM "fill";
DROP TABLE "fill";
